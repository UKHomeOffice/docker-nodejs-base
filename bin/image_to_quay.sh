...
docker tag nodejs-base:${DRONE_COMMIT_SHA} quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR}.${MINOR}.${PATCH}
...
docker tag nodejs-base:${DRONE_COMMIT_SHA} quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR}.${MINOR}
...
docker tag nodejs-base:${DRONE_COMMIT_SHA} quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR};
