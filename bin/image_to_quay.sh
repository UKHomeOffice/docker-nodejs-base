...
docker tag firearms quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR}.${MINOR}.${PATCH}
...
docker tag firearms quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR}.${MINOR}
...
docker tag firearms quay.io/ukhomeofficedigital/nodejs-base:v${MAJOR};
